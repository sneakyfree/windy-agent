...
> **GOAL:** Windy Fly lives inside Windy Chat as `@windyfly:chat.windypro.com`. Users open Windy Chat, see Windy Fly as a contact, and chat with their agent. Messages sync across desktop and mobile. Agent shows presence (online/offline) and typing indicators.
...
#   - On success: log "Windy Fly logged in as @windyfly:chat.windypro.com"
