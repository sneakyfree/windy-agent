"""Hardening tests for graceful degradation of live integrations.

Tests Windy Pro API tools (tools/windy_api.py) and agent loop resilience
when integrations are unreachable.
"""
