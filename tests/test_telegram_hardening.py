...
# The path/OS-state nudge tests were RETIRED 2026-07-18 in the
# steering->substrate migration: the keyword heuristics + per-turn
# injections they pinned are deleted (tool self-descriptions in
# filesystem.py/shell.py carry the guidance now; the live-model
# origin failures move to the weekly continuity battery).
