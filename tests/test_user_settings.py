...
class TestModelsCatalog:
    ...
    def test_resolve_short_alias(self):
        assert models_catalog.resolve("opus").id == "claude-opus-5-5"
    ...
    def test_resolve_friendly_alias(self):
        ...
        assert models_catalog.resolve("smartest").id == "claude-opus-5-5"
...
class TestCmdModel:
    ...
    async def test_cmd_model_switch_by_alias(self, tmp_state_path):
        ...
        # Persisted
        assert get_model("telegram", "1") == "claude-opus-5-5"
